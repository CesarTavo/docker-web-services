...
sudo chown -R $(whoami):$(whoami) /home/$USER4
sudo chown -R $(whoami):$(whoami) /home/$USER5

sudo chmod -R 755 /home/$USER1
sudo chmod -R 755 /home/$USER2
sudo chmod -R 755 /home/$USER3
sudo chmod -R 755 /home/$USER4
sudo chmod -R 755 /home/$USER5
...
# Drupal settings
sudo cp -R ./drupal_sites/ /home/$USER5/drupal_sites/
sudo chmod -R 777 /home/$USER5/drupal_sites/default/*
